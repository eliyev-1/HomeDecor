...
import discountImamage from "../../assets/home/dicount.png";
import "./discount.css";

function Discount() {
  return (
    <div className="discount">
      <div className="discount__bacground" 
         style={{
          backgroundImage: `url(${discountImamage})`,
      ...
      >
        ...
        <div className="discount__content">
          ...
          <div className="shopNowButton"><button>
          <svg
