...
let [image,setImage]=useState('productDetail__left__smallImages__item')
let handleSmallImageClick=()=>{
  setImage(image==="productDetail__left__smallImages__item"?"productDetail__left__smallImages__item__active":"productDetail__left__smallImages__item")
  ...
  function addCart() {
    setProdId(prev => {
      if(!prev.includes([id, num])) {
        return [...prev, [id, num]]
      }
    } )
  

    localStorage.setItem("cartproducts",JSON.stringify(prodId))
  }
  return (
    <>
      ...
      <div className="productDetail container">
        <div className="productDetail__left">
          ...
          <div className="productDetail__left__smallImages">
            ...
            <div className={image}>
              <img src={largeImage}
              onClick={ handleSmallImageClick}  alt="" />
            </div>
          </div>
        </div>
